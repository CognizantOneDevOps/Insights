...
#sudo make install && cd .. && sudo wget http://platform.cogdevops.com/insights_install/installationScripts/latest/RHEL/python/get-pip.py
...
echo "Get all avaiable Python Agents"
cd $INSIGHTS_AGENT_HOME
wget http://platform.cogdevops.com/insights_install/installationScripts/latest/RHEL/agents/PlatformAgents.zip -O PlatformAgents.zip
