...
export class ServerConfigurationService implements IServerConfigurationService {
    ...
    saveServerConfigurations(serverConfigJson: string): Promise<any> {
        ...
        var dataValue = auth_uuid + this.dataShare.encryptData(auth_uuid, serverConfigJson)  ;
        return this.restCallHandlerService.postWithData("SAVE_SERVER_CONFIG", dataValue, "", { 'Content-Type': 'application/x-www-form-urlencoded' }).toPromise();
    }
