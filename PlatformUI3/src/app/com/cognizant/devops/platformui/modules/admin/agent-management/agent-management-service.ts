...
export interface IAgentService {
    ...
    getDocrootAgentConfig(Version: string, toolName: string, isWebhook:boolean, type:string): Promise<any>;
...
export class AgentService implements IAgentService {
    ...
    getDocrootAgentConfig(Version: string, toolName: string, isWebhook:boolean, type:string): Promise<any> {
        return this.restCallHandlerService.get("DOCROOT_AGENT_TOOL_CONFIG_DETAILS", { 'version': Version, 'tool': toolName, 'isWebhook':isWebhook , 'type':type});
    }
