...
public class UserUtil {
	...
	public static void writeUserContext(UserContext userContext) throws Exception {
		String directoryPath = Config.get("USERCERT_FILEPATH").getAsString() + userContext.getAffiliation();
	...
	public static UserContext readUserContext(String affiliation, String username) throws Exception {
		String filePath = Config.get("USERCERT_FILEPATH") + affiliation + "/" + username + ".ser";
	...
	public static void cleanUp() {
		String directoryPath = Config.get("USERCERT_FILEPATH").getAsString();
		File directory = new File(directoryPath);
