...
public class CAClient {
	...
	public UserContext getUserContext(UserContext user) throws Exception {
		...
		Enrollment enrollment = UserUtil.getEnrollment(Config.get("KEY_FOLDER_PATH").getAsString(), Config.get("KEY_FILE_NAME").getAsString(), Config.get("CERT_FOLDER_PATH").getAsString(), Config.get("CERT_FILE_NAME").getAsString());
		user.setEnrollment(enrollment);
		UserUtil.writeUserContext(user);
	...
	public UserContext getUserContext(String userId) throws Exception {
        ...
        userContext.setAffiliation(Config.get("ORG1").getAsString());
        userContext.setMspId(Config.get("ORG1_MSP").getAsString());
