...
module ISightApp {
    ...
    export class AppSettingsService implements IAppSettingsService {
        static $inject = ['$q', '$resource', '$cookies', 'restCallHandlerService','$http'];
        constructor(private $q: ng.IQService, private $resource, private $cookies, private restCallHandlerService: IRestCallHandlerService, private $http) {
        }
