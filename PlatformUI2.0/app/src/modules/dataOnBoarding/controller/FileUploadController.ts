    ...
    export class FileUploadController {
        ...
        initApp($scope, $cookies, $http, dataOnBoardingService, homePageController,restAPIUrlService, $window): void {
            ...
            dataOnBoardingService.getMetaData().then(function(response) {
                ...
                var colArr = ["id","level_1","level_2","level_3","level_4","toolName","toolProperty1","propertyValue1","toolProperty2","propertyValue2","toolProperty3","propertyValue3","toolProperty4","propertyValue4","Action"];
                var CSV = '';    
                ...
                for (var i = 0; i < arrData.length; i++) {
                    ...
                    for (var index=0; index< colArr.length;index++) {
                            row += arrData[i].propertyMap[colArr[index]];
