...
public class WebhookServiceTestData {
	...
	String webhookJson ="{\r\n  \"toolName\":\"GIT\",\r\n  \"labelDisplay\":\"SCM:GIT:DATA\",\r\n  \"webhookName\":\"git_new\",\r\n  \"dataformat\":\"json\",\r\n  \"mqchannel\":\"IPW_git_new\",  \"responseTemplate\":\"head_commit.message=message,head_commit.timestamp=commitTime,repository.updated_at=updated_at,repository.created_at=created_at,repository.pushed_at=pushed_at\",\r\n  \"statussubscribe\":false,\r\n  \"derivedOperations\":[\r\n    {\r\n      \"wid\":-1,\r\n      \"operationName\":\"insightsTimex\",\r\n      \"operationFields\":{\r\n        \"timeField\":\"pushed_at\",\r\n        \"epochTime\":true,\r\n        \"timeFormat\":\"\"\r\n      },\r\n      \"webhookName\":\"\"\r\n    }\r\n  ],\r\n  \"dynamicTemplate\":\"{\\n  \\\"commits\\\":[\\n    {\\n      \\\"id\\\":\\\"commitIdDY\\\",\\n      \\\"url\\\":\\\"commitURLDY\\\",\\n      \\\"timestamp\\\":\\\"commitTimeDY\\\"\\n    }\\n  ]\\n}\",\r\n  \"isUpdateRequired\":true,\r\n  \"fieldUsedForUpdate\":\"id\",\r\n  \"eventConfig\":\"\",\r\n  \"isEventProcessing\":false\r\n}";
