...
public interface OutComeService {
	public int saveOutcomeConfig(JsonObject config) throws InsightsCustomException;
	...
	void updateOutcomeConfigStatus(JsonObject configJson) throws InsightsCustomException;
