...
public class InsightsKerberosServiceRequestToken extends AbstractAuthenticationToken{
	 ...
	 * @see UserDetails
	 */
	public InsightsKerberosServiceRequestToken(Object principal, KerberosTicketValidation ticketValidation,
	 ...
	 */
	public InsightsKerberosServiceRequestToken(byte[] token) {
		super(null);
		this.token = token;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		InsightsKerberosServiceRequestToken other = (InsightsKerberosServiceRequestToken) obj;
