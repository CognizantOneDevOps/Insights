...
public interface OfflineAlertingService {
	...
	public JsonObject getAlertExecutionRecordsByWorkflowId(JsonObject alertConfigIdJson) throws InsightsCustomException;
