...
do
case $package in
   "insights_first") sudo wget https://raw.githubusercontent.com/CognizantOneDevOps/Insights/master/PlatformDeployment/RHEL7/reference-DocRoot-Scripts/insights_first.sh -O insights_first.sh && dos2unix insights_first.sh  && sh insights_first.sh
   ;;
   "insights_java") sudo wget https://raw.githubusercontent.com/CognizantOneDevOps/Insights/master/PlatformDeployment/RHEL7/reference-DocRoot-Scripts/insights_java.sh -O insights_java.sh && dos2unix insights_java.sh && sh insights_java.sh
   ;;
   "insights_postgres") sudo wget https://raw.githubusercontent.com/CognizantOneDevOps/Insights/master/PlatformDeployment/RHEL7/reference-DocRoot-Scripts/insights_postgres.sh -O insights_postgres.sh && dos2unix insights_postgres.sh && sh insights_postgres.sh
   ;;
   "insights_grafana") sudo wget https://raw.githubusercontent.com/CognizantOneDevOps/Insights/master/PlatformDeployment/RHEL7/reference-DocRoot-Scripts/insights_grafana.sh -O insights_grafana.sh && dos2unix insights_grafana.sh && sh insights_grafana.sh
   ;;
   ...
   ;;
   "insights_UI_Service") sudo wget https://raw.githubusercontent.com/CognizantOneDevOps/Insights/master/PlatformDeployment/RHEL7/reference-DocRoot-Scripts/insights_UI_Service.sh -O insights_UI_Service.sh && dos2unix insights_UI_Service.sh && sh insights_UI_Service.sh
   ;;
