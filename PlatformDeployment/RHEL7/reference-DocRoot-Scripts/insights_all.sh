...
wget https://raw.githubusercontent.com/CognizantOneDevOps/Insights/master/PlatformDeployment/RHEL7/reference-DocRoot-Scripts/insights_first.sh -O insights_first.sh && dos2unix insights_first.sh && sh insights_first.sh
echo "Installing Java"
wget https://raw.githubusercontent.com/CognizantOneDevOps/Insights/master/PlatformDeployment/RHEL7/reference-DocRoot-Scripts/insights_java.sh -O insights_java.sh && dos2unix insights_java.sh && sh insights_java.sh
echo "Install Postgres"
wget https://raw.githubusercontent.com/CognizantOneDevOps/Insights/master/PlatformDeployment/RHEL7/reference-DocRoot-Scripts/insights_postgres12.sh -O insights_postgres.sh && dos2unix insights_postgres.sh && sh insights_postgres.sh
echo "Install Grafana"
wget https://raw.githubusercontent.com/CognizantOneDevOps/Insights/master/PlatformDeployment/RHEL7/reference-DocRoot-Scripts/insights_grafana.sh -O insights_grafana.sh && dos2unix insights_grafana.sh && sh insights_grafana.sh
echo "Install Neo4j"
wget https://raw.githubusercontent.com/CognizantOneDevOps/Insights/master/PlatformDeployment/RHEL7/reference-DocRoot-Scripts/insights_neo4j.sh -O insights_neo4j.sh && dos2unix insights_neo4j.sh && sh insights_neo4j.sh
echo "Install Python 3.10 with required libraries needed for Insights"
