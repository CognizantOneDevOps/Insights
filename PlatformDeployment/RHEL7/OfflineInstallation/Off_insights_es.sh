...
# arfifacts
# http://platform.cogdevops.com/insights_install/installationScripts/latest/RHEL/es/elasticsearch-5.6.4.rpm
# http://platform.cogdevops.com/insights_install/installationScripts/latest/RHEL/es/ElasticSearch-5.6.4.zip


echo "#################### Installing Eleastic Search with configs ####################"
sudo mkdir elasticsearch
cd elasticsearch
sudo cp /usr/Offline_Installation/Elasticsearch/elasticsearch-5.6.4.rpm ./
sudo rpm -Uvh elasticsearch-5.6.4.rpm
sudo cp -R  /usr/Offline_Installation/Elasticsearch/ElasticSearch-5.6.4/ ./
