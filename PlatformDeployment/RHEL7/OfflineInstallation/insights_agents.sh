...
cd AgentDaemon
#sudo cp $INSIGHTS_OFFLINE_ARTIFACTS_DIRECTORY/Agents/agentdaemon.zip .
...
sudo cp -R $INSIGHTS_OFFLINE_ARTIFACTS_DIRECTORY/Agents/agentdaemon/* .
source /etc/environment
source /etc/profile
...
sudo mkdir $INSIGHTS_APP_ROOT_DIRECTORY/agentunzip/
sudo chmod -R 777 $INSIGHTS_APP_ROOT_DIRECTORY/agentunzip
sleep 30
