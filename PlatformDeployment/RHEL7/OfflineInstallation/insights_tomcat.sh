...
#sudo cp $INSIGHTS_OFFLINE_ARTIFACTS_DIRECTORY/Tomcat/PlatformUI3.zip .
...
sudo cp $INSIGHTS_OFFLINE_ARTIFACTS_DIRECTORY/Tomcat/PlatformService.war .
...
sudo cp $INSIGHTS_OFFLINE_ARTIFACTS_DIRECTORY/Tomcat/apache-tomcat.tar.gz .
...
sudo cp -R $INSIGHTS_OFFLINE_ARTIFACTS_DIRECTORY/Tomcat/PlatformUI3/app $INSIGHTS_APP_ROOT_DIRECTORY/apache-tomcat/webapps
...
cd /etc/init.d/
sudo cp $INSIGHTS_OFFLINE_ARTIFACTS_DIRECTORY/Tomcat/Tomcat.sh .
