...
#read releaseVersion
#sudo wget https://github.com/CognizantOneDevOps/Insights/releases/download/v${releaseVersion}/plugins.zip
cd /opt
...
echo "To set postgres grafana user credentials"
echo -n "credentials: "
read -s grafanacreds
...
source /etc/environment
source /etc/profile
sudo nohup /opt/grafana/bin/grafana-server &
