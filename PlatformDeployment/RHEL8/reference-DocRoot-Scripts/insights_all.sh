...
wget https://raw.githubusercontent.com/CognizantOneDevOps/Insights/master/PlatformDeployment/RHEL8/reference-DocRoot-Scripts/insights_UI_Service.sh -O insights_UI_Service.sh && dos2unix insights_UI_Service.sh && sh insights_UI_Service.sh
...
wget https://raw.githubusercontent.com/CognizantOneDevOps/Insights/master/PlatformDeployment/RHEL8/reference-DocRoot-Scripts/insights_workflow.sh -O insights_workflow.sh && dos2unix insights_workflow.sh && sh insights_workflow.sh
...
wget https://raw.githubusercontent.com/CognizantOneDevOps/Insights/master/PlatformDeployment/RHEL8/reference-DocRoot-Scripts/server_setup_details.sh -O server_setup_details.sh && dos2unix server_setup_details.sh && sh server_setup_details.sh
