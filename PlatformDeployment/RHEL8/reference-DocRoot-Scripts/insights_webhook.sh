...
source /etc/environment
source /etc/profile
sudo wget https://infra.cogdevops.com/repository/docroot/insights_install/release/latest/PlatformInsightsWebHook.jar -O PlatformInsightsWebHook.jar
sudo wget https://infra.cogdevops.com/repository/docroot/insights_install/installationScripts/latest/RHEL8/scripts/webhook_subscriber.properties -O webhook_subscriber.properties
...
cd /etc/init.d/
sudo wget https://infra.cogdevops.com/repository/docroot/insights_install/installationScripts/latest/RHEL8/initscripts/InSightsWebHook.sh
