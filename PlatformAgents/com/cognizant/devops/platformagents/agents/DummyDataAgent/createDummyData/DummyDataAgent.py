...
class DummyDataAgent(BaseAgent):
    def process(self):
        ...
        jira_key = ['IS-10','IS-11','IS-12','IS-13','IS-14']
        Story_Id = ['IS-10','IS-11','IS-12','IS-13','IS-14']
	...
	SCM_commitID = ['123','456','789','111']
        ...
        file_path = os.path.join('C:\\InSights_V1.0\\Agents\\PlatformAgents\\com\\cognizant\\devops\\platformagents\\agents\\ci\\test1\\tracking.json')
        ...
        while flag == 1:
            ...
            jiraSample['sprints'] = random.choice(sprints)
            jiraSample['sprints1'] = random.choice(sprints1)
            jiraSample['issueType'] = random.choice(issue_Type)
            jiraSample['key'] = random.choice(jira_key)
	    ...
	    jiraSample['assigneeEmail'] = random.choice(assigneeEmail)
            ...
            jiraSample['sprintId'] = random.choice(Sprint_Id)
	    ...
	    sprintSample['sprintId'] = random.choice(sprint_Id)
	    ...
	    gitSample['commitId'] = random.choice(Commit_Id)
	    ...
	    jenkinsSample['scmcommitId'] = random.choice(SCM_commitID)
	    ...
	    sonarSample['inSightsTimeX']= random.choice(resourceKey)
            ...
            self.publishToolsData(sonar_data)
