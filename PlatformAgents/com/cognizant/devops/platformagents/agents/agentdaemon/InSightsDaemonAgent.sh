...
detectPythonVersion()
{
     if echo "$1" | grep -q "Python 2"; then
      ...
      python -c "from __AGENT_KEY__.com.cognizant.devops.platformagents.agents.agentdaemon.AgentDaemonExecutor import AgentDaemonExecutor; AgentDaemonExecutor()" &
     elif echo "$1" | grep -q "Python 3"; then
      echo "Detected python 3 version";
      python -c "from __AGENT_KEY__.com.cognizant.devops.platformagents.agents.agentdaemon.AgentDaemonExecutor3 import AgentDaemonExecutor; AgentDaemonExecutor()" &
     else
