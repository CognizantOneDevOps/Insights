 ...
 * Initialize BlockChain and JiraProcessing Module.
 */
	...
	public static void main(String[] args) {
		...
		try {
			...
			EnterpriseEngineStatusLogger.getInstance().createEngineStatusNode(
					"Platform Enterprise Engine Service Started ", PlatformServiceConstants.SUCCESS);

		} catch (Exception e) {
			EnterpriseEngineStatusLogger.getInstance().createEngineStatusNode(
					"Platform Enterprise Engine Service not running " + e.getMessage(),
