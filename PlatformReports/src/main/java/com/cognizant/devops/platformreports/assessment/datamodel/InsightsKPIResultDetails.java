...
public class InsightsKPIResultDetails {
	...
	public String toString() {
		return "InferenceKPIResultDetails [kpiId=" + kpiId + ", name=" + name + ", schedule=" + schedule + ", group="
				+ group + ", toolName=" + toolName + ", resultField=" + resultField + ", results=" + results + ", resultTime=" + resultTime + ", resultTimeX=" + resultTimeX
