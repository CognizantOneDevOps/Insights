  ...
  _createClass(ConfigEditor, [{
    ...
    value: function render() {
      var _this$props4 = this.props,
          ...
          onOptionsChange = _this$props4.onOptionsChange; //const { jsonData, secureJsonFields } = options;
      //const secureJsonData = (options.secureJsonData || {}) as MySecureJsonData;

      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__.DataSourceHttpSettings, {
...
var DataSource = /*#__PURE__*/function (_DataSourceApi) {
  ...
  _createClass(DataSource, [{
    ...
    value: function query(options) {
      ...
      cypherQuery['metadata'] = metadata; // Start streams and prepare queries
    ...
    value: function metricFindQuery(query, options) {
      ...
      var statements = [];
      cypherQuery['statements'] = statements;
      query = (0,Utils__WEBPACK_IMPORTED_MODULE_3__.addTimestampToQuery)(query, null);
