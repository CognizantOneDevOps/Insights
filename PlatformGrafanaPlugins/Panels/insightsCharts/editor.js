System.register(["lodash", "../insightsCore/BaseEditor", "../insightsCore/BaseCharts", "../insightsCore/ChartModel", "./models"], function (exports_1, context_1) {
    "use strict";
    ...
    var lodash_1, BaseEditor_1, BaseCharts_1, ChartModel_1, models_1, InsightsChartsEditorCtrl;
    return {
        setters: [
            function (lodash_1_1) {
                lodash_1 = lodash_1_1;
        ...
        execute: function () {
            InsightsChartsEditorCtrl = /** @class */ (function (_super) {
                __extends(InsightsChartsEditorCtrl, _super);
                /** @ngInject */
                function InsightsChartsEditorCtrl($scope, $q, uiSegmentSrv) {
                    var _this = _super.call(this, $scope, $q, uiSegmentSrv) || this;
                    _this.supportedDataTypes = BaseCharts_1.BaseCharts.supportedDataTypes;
                    _this.insightsPanelData = _super.prototype.getInsightsPanelData.call(_this);
                    _this.chartVisible = false;
                    _this.insightsChartEditorModel = _this.insightsPanelData['insightsChartEditorModel'];
                    //chipsModel: any = {};
                    _this.columnCache = {};
                    _this.process();
                    return _this;
                    ...
                    if (this.parsedResponseArray.length > 0) {
                        ...
                        for (var _i = 0, _a = this.parsedResponseArray; _i < _a.length; _i++) {
                            ...
                            for (var _d = 0, _e = responseData.columns; _d < _e.length; _d++) {
                                var column = _e[_d];
                                for (var _f = 0, preConfiguredColumns_1 = preConfiguredColumns; _f < preConfiguredColumns_1.length; _f++) {
                                    var preConfiguredColumn = preConfiguredColumns_1[_f];
                        ...
                        for (var _i = 0, _a = this.parsedResponseArray; _i < _a.length; _i++) {
                            ...
                            for (var _b = 0, _c = this.insightsChartEditorModel.targets; _b < _c.length; _b++) {
                                ...
                                if (target.id === parsedResponse.target) {
                                    ...
                                    for (var _d = 0, availabelColumns_1 = availabelColumns; _d < availabelColumns_1.length; _d++) {
                                        var column = availabelColumns_1[_d];
