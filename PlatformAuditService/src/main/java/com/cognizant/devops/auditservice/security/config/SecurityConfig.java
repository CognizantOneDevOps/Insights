 ...
 * the License.
 ******************************************************************************/
package com.cognizant.devops.auditservice.security.config;
...
@ComponentScan(basePackages = {"com.cognizant.devops.auditservice"})
@Configuration
@EnableWebSecurity
@EnableWebMvc
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public DefaultSpringSecurityContextSource getDefaultSpringSecurityContextSource() {
		log.info(" auth "+ApplicationConfigProvider.getInstance().isDisableAuth()+" EnableNativeUsers " +ApplicationConfigProvider.getInstance().isEnableNativeUsers());
