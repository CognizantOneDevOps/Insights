...
public class WebhookTestData {
	...
	private static final Logger log = LogManager.getLogger(WebhookTestData.class);
	...
	public String getXSRFToken(String jSessionId) throws InterruptedException, IOException{
		...
		RestAssured.baseURI = CommonUtils.getProperty("baseURI") + "/PlatformService/admin/webhook/loadwebhookConfiguration";
		RequestSpecification httpRequest = RestAssured.given();
