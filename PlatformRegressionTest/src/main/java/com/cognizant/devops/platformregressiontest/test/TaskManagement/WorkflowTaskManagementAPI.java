...
public class WorkflowTaskManagementAPI {

	private static final Logger log = LogManager.getLogger(WorkflowTaskManagementAPI.class);

	@Test(priority = 1)
	public void getAllWorkflowTask() {

		RestAssured.baseURI = CommonUtils.getProperty("baseURI") + CommonUtils.getProperty("getAllWorkflowTask");
	...
	@Test(priority = 2)
	public void getAllWorkflowType() {

		RestAssured.baseURI = CommonUtils.getProperty("baseURI") + CommonUtils.getProperty("getAllWorkflowType");
