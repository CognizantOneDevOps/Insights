...
public class MultipleEmailRepoMgmConfiguration extends MultipleEmailRepoMgmObjectRepository{
	
	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));

	private static final Logger log = LogManager.getLogger(MultipleEmailRepoMgmConfiguration.class);

	public MultipleEmailRepoMgmConfiguration() {
	...
	public boolean navigateToGroupEmailConfigPage() {
		try {
			...
			log.info("Landing page displayed : {}", visibilityOf(landingPage, 2));
	 ...
	 * @return
	 */
	public boolean createGroupEmailReportMgm(GroupEmailDashRepoDataModel data) {
		try {
			clickAddButton();
	 ...
	 * @return
	 */
	public boolean editGroupEmailReportMgm(GroupEmailDashRepoDataModel data) {
		try {
