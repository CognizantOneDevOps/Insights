...
public class OfflineAgentTest extends AgentObjectRepository {

	private static final Logger log = LogManager.getLogger(OfflineAgentTest.class);
	 ...
	 * @throws InterruptedException
	 */
	@Test(priority = 2, enabled = true, dataProvider = "agentofflinedataprovider", dataProviderClass = AgentDataProvider.class)
	 ...
	 * @throws InterruptedException
	 */
	@Test(priority = 3, enabled = true, dataProvider = "agentofflinedataprovider", dataProviderClass = AgentDataProvider.class)
	 ...
	 * @throws InterruptedException
	 */
	@Test(priority = 4, enabled = true, dataProvider = "agentofflinedataprovider", dataProviderClass = AgentDataProvider.class)
	 ...
	 * @throws InterruptedException
	 */
	@Test(priority = 5, enabled = true, dataProvider = "agentofflinedataprovider", dataProviderClass = AgentDataProvider.class)
	 ...
	 * @throws InterruptedException
	 */
	@Test(priority = 6, enabled = true, dataProvider = "agentofflinedataprovider", dataProviderClass = AgentDataProvider.class)
	 ...
	 * @throws InterruptedException
	 */
	@Test(priority = 7, enabled = true, dataProvider = "agentofflinedataprovider", dataProviderClass = AgentDataProvider.class)
