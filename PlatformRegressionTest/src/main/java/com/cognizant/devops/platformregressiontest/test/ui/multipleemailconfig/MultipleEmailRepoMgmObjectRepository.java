...
public class MultipleEmailRepoMgmObjectRepository extends LoginAndSelectModule{

	@FindBy(xpath = "//span[contains(text(),'Assessment Report Configuration ')]")   //
	WebElement repoMgmLandingPage;
	...
	@FindBy(xpath = "//div[contains(text(), 'Workflow History Detail ')]")
