...
public class DataArchivalDataSubscriber extends EngineSubscriberResponseHandler {
	...
	private static Logger log = LogManager.getLogger(DataArchivalDataSubscriber.class.getName());
	...
	public void handleDelivery(String consumerTag, Envelope envelope, BasicProperties properties, byte[] body)
		...
		JsonObject updateURLJson = parser.parse(message).getAsJsonObject();
		dataArchivalConfigDAL.updateArchivalSourceUrl(updateURLJson.get("archivalName").getAsString(), updateURLJson.get("sourceUrl").getAsString());
