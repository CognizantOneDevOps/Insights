...
public class WorkflowTestTaskSubscriber extends WorkflowTaskSubscriberHandler {
	...
	private static Logger log = LogManager.getLogger(WorkflowTestTaskSubscriber.class.getName());
	...
	public WorkflowTestTaskSubscriber(String routingKey) throws Exception {
		super(routingKey);
	}

	@Override
	public void handleTaskExecution(byte[] body)
			throws IOException {
		try {
