...
export class UserOnboardingService implements IUserOnboardingService {
  ...
  getCurrentUserOrgs(): Promise<any> {
    return this.restHandler.get(
      "ACCESS_GROUP_MANAGEMENT_GET_CURRENT_USER_ORGS"
    );
  }
  ...
  switchUserOrg(orgId: number): Promise<any> {
    return this.restHandler
      .postWithParameter(
        "ACCESS_GROUP_MANAGEMENT_SWITCH_ORGS",
        { orgId: orgId },
        { "Content-Type": "application/x-www-form-urlencoded" }
      )
      .toPromise();
  ...
  editUserOrg(orgId: number, userId: number, role: String): Promise<any> {
    return this.restHandler
      .postWithParameter(
        "ACCESS_GROUP_MANAGEMENT_EDIT_ORGS_UESRS",
  ...
  deleteUserOrg(orgId: number, userId: number, role: String): Promise<any> {
    return this.restHandler
      .postWithParameter(
        "ACCESS_GROUP_MANAGEMENT_DELETE_ORGS_UESRS",
        { orgId: orgId, userId: userId, role: role },
        { "Content-Type": "application/x-www-form-urlencoded" }
      )
      .toPromise();
  ...
  addUserInOrg(userPropertyList: string) {
    return this.restHandler.postWithData("USER_CREATE", userPropertyList, "", {
      "Content-Type": "application/x-www-form-urlencoded",
    });
  }
  assignUser(assignUserList: string) {
    return this.restHandler.postWithData("ASSIGN_USER", assignUserList, "", {
      "Content-Type": "application/json",
    });
  }
  getUsersOrganisation(userName: string) {
    return this.restHandler
      .postWithData("USER_ORG_SEARCH", userName, "", {
        "Content-Type": "application/x-www-form-urlencoded",
      })
      .toPromise();
  }
