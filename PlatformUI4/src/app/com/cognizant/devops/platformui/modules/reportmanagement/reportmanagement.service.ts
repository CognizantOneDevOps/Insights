...
export class ReportManagementService {
  ...
  updateDataforReport(reportJson: string): Promise<any> {
    return this.restCallHandlerService
      .postWithData("UPDATE_REPORT", reportJson, "", {
        "Content-Type": "application/x-www-form-urlencoded",
      })
      .toPromise();
  }
  ...
  setActiveStatus(reportJson: string) {
    return this.restCallHandlerService
      .postWithData("STATE_CHANGE", reportJson, "", {
        "Content-Type": "application/x-www-form-urlencoded",
      })
      .toPromise();
  }
  ...
  getWorkflowExecutionRecords(configIdJson: string) {
    return this.restCallHandlerService
      .postWithData("GET_WORKFLOW_EXECUTION_RECORDS", configIdJson, "", {
        "Content-Type": "application/json",
      })
      .toPromise();
  }
  ...
  setRetryStatus(configStatusMapping: string) {
    return this.restCallHandlerService
      .postWithData("SET_REPORT_STATUS", configStatusMapping, {
        "Content-Type": "application/json",
      })
      .toPromise();
  }
  ...
  getPDFExecutionId(configIdJson: string) {
    return this.restCallHandlerService
      .postWithData("GET_PDF_EXECUTIONID", configIdJson, "", {
        "Content-Type": "application/json",
      })
      .toPromise();
  }
