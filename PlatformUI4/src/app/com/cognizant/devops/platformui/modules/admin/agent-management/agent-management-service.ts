...
export class AgentService implements IAgentService {
  ...
  loadHealthConfigurations(
    ...
    return this.restCallHandlerService.get("HEALTH_TOOL", {
      tool: toolName,
  ...
  getDocrootAgentConfig(
    ...
    return this.restCallHandlerService.get(
      "DOCROOT_AGENT_TOOL_CONFIG_DETAILS",
      { version: Version, tool: toolName, isWebhook: isWebhook, type: type }
    );
  }

  getDbAgentConfig(agentId: string): Promise<any> {
    return this.restCallHandlerService.get("DB_AGENT_CONFIG_DETAILS", {
      agentId: agentId,
    });
  }
  ...
  agentUninstall(
    ...
    return this.restCallHandlerService
      .postWithParameter(
        "AGENT_UNINSTALL",
        { agentId: agentId, toolName: toolName, osversion: osversion },
        { "Content-Type": "application/x-www-form-urlencoded" }
      )
      .toPromise();
  }
  ...
  registerAgentV2(registerAgentJson: string): Promise<any> {
    return this.restCallHandlerService
      .postWithAgentData("AGENT_REGISTERV2", registerAgentJson, "", {
        "Content-Type": "application/x-www-form-urlencoded",
      })
      .toPromise();
  }
  ...
  updateAgentV2(agentMappingJson: string): Promise<any> {
    return this.restCallHandlerService
      .postWithAgentData("AGENT_UPDATEV2", agentMappingJson, "", {
        "Content-Type": "application/x-www-form-urlencoded",
      })
      .toPromise();
  }

  getAgentTags(): Promise<any> {
    return this.restCallHandlerService.get("AGENT_TAGS");
  }

  downloadAgentPackage(agentVersion): Promise<any> {
    return this.restCallHandlerService.get("DOWNLOAD_AGENTS_PACKAGE", {
