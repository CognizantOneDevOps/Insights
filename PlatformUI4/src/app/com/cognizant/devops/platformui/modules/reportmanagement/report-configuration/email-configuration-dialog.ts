...
export class EmailConfigurationDialog {
  ...
  constructor(
    public dialogRef: MatDialogRef<EmailConfigurationDialog>,
  ...
  initializeVariables() {
    if (this.data.type == "edit" && this.data.emailDetails) {
      ...
      this.receiverBCCEmailAddress =
        this.data.emailDetails.receiverBCCEmailAddress;
      this.mailSubject = this.data.emailDetails.mailSubject;
      this.mailBodyTemplate = this.data.emailDetails.mailBodyTemplate
        .replace(/#/g, "<")
        .replace(/~/g, ">");
  ...
  saveEmailConfig() {
    ...
    if (isValidated) {
      this.mailBodyTemplate = this.mailBodyTemplate
        .replace(/</g, "#")
        .replace(/>/g, "~");
      let emailDetailsJson = {
        ...
        receiverCCEmailAddress: self.receiverCCEmailAddress,
        receiverBCCEmailAddress: self.receiverBCCEmailAddress,
      };
