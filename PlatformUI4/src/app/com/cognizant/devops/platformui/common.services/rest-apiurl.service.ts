...
export class RestAPIurlService implements IRestAPIUrlService {
    ...
    public initializeEndpoints() {
        ...
        this.addEndPoint("AGENT_TAGS", '/PlatformService/admin/agentConfiguration/getAvailableAgentTags');
        this.addEndPoint("DOWNLOAD_AGENTS_PACKAGE", '/PlatformService/admin/agentConfiguration/downloadAgentPackage');
        //Data Dictonary 
